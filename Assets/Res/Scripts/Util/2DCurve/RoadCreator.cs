...
public class RoadCreator : MonoBehaviour
{
    ...
    {
        Path2D path = GetComponent<PathCreator>().path;
        Vector2[] points = path.CalculateEvenlySapcedPoints(spacing);//所有中间点
        int textureRepeat = Mathf.RoundToInt(tiling * points.Length * spacing * 0.05f);//texture重复
