...
public class TerrainSlice : Editor

{
    ...
    private static TerrainData Check()
    {
        ...
        if (Selection.activeObject != null)
        {
            ...
            if (Selection.activeObject.GetType() == typeof(GameObject))
            {
                ...
                mainData = obj.GetComponent<Terrain>().terrainData;
...

    {
        ...
        if (mainData != null)
        {
            ...
            var heightX = (mainData.heightmapResolution - 1) / SLICING_NUM;

            var heightY = (mainData.heightmapResolution - 1) / SLICING_NUM;
