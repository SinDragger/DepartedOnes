...
public class SSPA_MoveCharacterAndWait : StoryScriptPlayerAction
{
    public override string processHead => "MoveCharacterAndWait";
    ...
    public override bool ComfirmBlockEnd()
    {
        ...
        //返回clicktomove的Moving即可 但是需要取反

        return !character.refData.model.actionModel.agentMoving;
    }
}
