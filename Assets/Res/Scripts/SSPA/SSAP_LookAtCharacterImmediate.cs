...
public class SSAP_LookAtCharacterImmediate : StoryScriptPlayerAction
{
    public override string processHead => "LookAtCharacterImmediate";
    ...
    public override void ProcessParamLine(string[] paramLine)
    {
        ...
        if (character != null)
        {
            ...
            else
            {
                ...
                CameraControl.Instance.LookAtV3Immediate(character.refData.model.transform.position + pos);
            }
        }
    }
